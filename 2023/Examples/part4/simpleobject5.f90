...
! March 2022.
! 
! Compile gfortran simpleobject5.f90
! run ./a.out 
!
!
!
...
! No loop here, illustrate optional arguments.
  call st(1)%gen(5) ! Call target directly 
  
  pt => st(2)       ! Let pointer pt point to second element. 
  call pt%gen(20)   ! Pointer pt used. 

  call st(3)%gen    ! Or just access the 3. element. 
