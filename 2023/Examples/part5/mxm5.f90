...
!
! Check if array indexes are within declared intervals : -fcheck=bounds
! Performance impact.
...
subroutine mxm(x,y,z) 
  ...
  real(real64), contiguous, dimension(:,:), intent(in)  :: x,y
  real(real64), contiguous, dimension(:,:), intent(inout) :: z
...
program mx
  ...
  call start_timer
  call mxm(a(1::2,1::2),b(1::2,1::2),c(1::2,1::2))  ! Every second element, not contigous.
  call stop_timer
  call showresults(n)
